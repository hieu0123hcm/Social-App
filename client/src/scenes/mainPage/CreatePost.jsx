...
const CreatePost = ({handleClose}) => {
  ...
  return (
    <Stack flexDirection={'column'} justifyContent={'center'} width={'500px'}
        height={'auto'}
    ...
    >
        ...
        <Stack flexDirection={'row'} alignItems={'center'}>
            <Avatar alt="User Avatar" src={`http://localhost:5000/assets/${user.picturePath}`} />
            <Typography
            marginLeft={'10px'}
            fontSize={'14px'}
            fontWeight={'500'}
        ...
        sx={{marginTop:'10px',color:'white', backgroundColor:COLORS.contrast}}>
            Post
        </Button>
    </Stack>
  )
